                ...
                <div className="relative container mx-auto px-4 py-20 max-w-5xl">
                    <div className="flex flex-col md:flex-row gap-8 items-start justify-between">
                        <div className="max-w-2xl">
                            ...
                            <p className="text-lg text-blue-200/70 mb-6 leading-relaxed">
                            ...
                            <div className="flex flex-wrap items-center gap-6 text-sm font-medium text-blue-200 bg-white/5 backdrop-blur-sm border border-white/10 py-3 px-5 rounded-xl">
                        ...
                        {kurikulumAktif.dokumenUrl && (
                            <a href={kurikulumAktif.dokumenUrl} target="_blank" rel="noreferrer" className="shrink-0 w-full md:w-auto mt-4 md:mt-0">
                                <Button size="lg" className="w-full md:w-auto h-14 px-6 text-base bg-white text-slate-900 hover:bg-blue-50 shadow-xl shadow-black/20 transition-all font-semibold">
                                ...
                                <div className="overflow-x-auto">
                                    <Table>
                                        <TableHeader className="bg-zinc-50/80">
                                            <TableRow>
                                                <TableHead className="w-[120px] font-semibold text-zinc-900">Kode MK</TableHead>
                                                <TableHead className="font-semibold text-zinc-900">Nama Mata Kuliah</TableHead>
                                                <TableHead className="w-[100px] text-center font-semibold text-zinc-900">SKS</TableHead>
                                                <TableHead className="w-[150px] font-semibold text-zinc-900">Jenis</TableHead>
                                            </TableRow>
                                        </TableHeader>
                                        <TableBody>
                                            {mataKuliah.map((mk) => (
                                                <TableRow key={mk.id} className="hover:bg-blue-50/30 transition-colors">
                                                    ...
                                                    <TableCell>
                                                        <p className="font-bold text-zinc-900">{mk.nama}</p>
                                                        {mk.deskripsi && (
                                                            <p className="text-sm text-zinc-500 mt-1 line-clamp-2" title={mk.deskripsi}>
                                                                {mk.deskripsi}
                                                            </p>
                                                        )}
                                                    </TableCell>
