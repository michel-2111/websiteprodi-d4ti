...
export default async function AdminDataDosenPage() {
    const dosenList = await prisma.user.findMany({
        ...
        dosenProfile: {
            include: {
            _count: {
                select: { publikasi: true, penelitian: true, pengabdian: true, sertifikat: true }
            }
            }
        }
        },
        ...
        <div className="rounded-md border bg-white overflow-hidden shadow-sm">
            ...
            <TableBody>
                ...
                const totalKarya = profil 
                    ? profil._count.publikasi + profil._count.penelitian + profil._count.pengabdian + profil._count.sertifikat 
                    : 0;
