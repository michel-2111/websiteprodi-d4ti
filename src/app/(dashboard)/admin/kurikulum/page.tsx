...
import { setKurikulumAktif, deleteKurikulum, getKurikulum } from "@/src/app/actions/kurikulum"; // 1. Tambahkan getKurikulum
...
export default async function KurikulumPage() {
    ...
    const dataKurikulum = await getKurikulum();
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    {/* 5. Ubah sub-deskripsi menjadi dinamis */}
                    <p className="text-zinc-500">
                        Kelola kurikulum dan mata kuliah {prodiAktif ? prodiAktif.nama : "Program Studi"}.
                    </p>
                </div>
