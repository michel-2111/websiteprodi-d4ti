...
import { deleteAktifitas, getAktifitas } from "@/src/app/actions/aktifitas";
...
export default async function AktifitasPage() {
    const aktifitas = await getAktifitas();
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-zinc-500">
                        Kelola publikasi kegiatan {prodiAktif ? prodiAktif.nama : "Program Studi"}.
                    </p>
                </div>
                        ...
                        {aktifitas.length === 0 && (
                            <TableRow>
                                <TableCell colSpan={5} className="text-center text-zinc-500 h-24">
                                    Belum ada data aktifitas untuk prodi ini.
                                </TableCell>
                            </TableRow>
                        )}
                    </TableBody>
